<template>
  <div class="m-products-list">
    ...
    <el-row>
         <item v-for="(item,index) in goodList"  :key="index" :meta="item" />
      ...
      productList: [
        {
          itemId: "2571323",
          title: "井格重庆火锅（哈西万达店）",
          image: "https://p0.meituan.net/merchantpic/30eab3a5c05e3646e1a68ac27a80c641379674.jpg@275w_156h_1e_1c",
          type: "food",
          score: 5,
          commentNum: 2555,
          comment: [
